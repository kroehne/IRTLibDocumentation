...
`https://{URL des Players}/{Studienname}/api/session/?apiKey={ExternalExportKey}`
...
`https://{URL des Players}/{Studienname}/api/session/{Session-Identifier}/result?apiKey={ExternalExportKey}`
